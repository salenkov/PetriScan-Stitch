...
def add_number_to_image(image, number, position=(10, 10), font_size=60, opacity=128):
...
def stitch_images(images_folder, output_folder):
    ...
    for row in tqdm(range(total_rows), desc="Stitching Progress", unit="row"):
        ...
        # Determine the order of numbering based on the row index
        if row % 2 == 0:
            # First 16 images number backwards from 16 to 1
            ...
            # Next 16 images number forwards from 17 to 32
