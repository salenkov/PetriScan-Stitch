...
if __name__ == "__main__":
    ...
    folder = "/home/pi/Downloads/EnderScope-main/Software/Img/"
...
# x,y = snake(16, 20, 147.2) # start from bottom left corner
x,y = snake(16, 20, 102.4) # start from bottom left corner
...
try:
    ...
    for i in range(len(x)):
        ...
        ser.write(Mot)
        time.sleep(0.5)
        camera.capture("%s_%s.jpg" % (folder, i))
        time.sleep(0.5)
    lights.light_off()
